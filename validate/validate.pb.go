...
type StringRules struct {
	...
	// Utf16ByteLen specifies that this field must be the specified number of UTF16 bytes.
	Utf16ByteLen *uint64 `protobuf:"varint,27,opt,name=utf16_byte_len,json=utf16ByteLen" json:"utf16_byte_len,omitempty"`
	// MinUtf16ByteLen specifies that this field must be the specified number of UTF16 bytes at a minimum.
	MinUtf16ByteLen *uint64 `protobuf:"varint,28,opt,name=min_utf16_byte_len,json=minUtf16ByteLen" json:"min_utf16_byte_len,omitempty"`
	// MaxUtf16ByteLen specifies that this field must be the specified number of UTF16 bytes at a maximum.
	MaxUtf16ByteLen *uint64 `protobuf:"varint,29,opt,name=max_utf16_byte_len,json=maxUtf16ByteLen" json:"max_utf16_byte_len,omitempty"`
}
...
func (x *StringRules) GetUtf16ByteLen() uint64 {
	if x != nil && x.Utf16ByteLen != nil {
		return *x.Utf16ByteLen
	}
	return 0
}

func (x *StringRules) GetMinUtf16ByteLen() uint64 {
	if x != nil && x.MinUtf16ByteLen != nil {
		return *x.MinUtf16ByteLen
	}
	return 0
}

func (x *StringRules) GetMaxUtf16ByteLen() uint64 {
	if x != nil && x.MaxUtf16ByteLen != nil {
		return *x.MaxUtf16ByteLen
	}
	return 0
}
...
var file_validate_validate_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x63, 0x6f, 0x6e, 0x73, 0x74, 0x22, 0xd4, 0x06, 0x0a, 0x0b, 0x53, 0x74, 0x72, 0x69,
	...
	,
